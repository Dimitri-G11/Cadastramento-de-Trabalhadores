"""
Django settings for AuthCrud project.
...
SECRET_KEY = 'django-insecure-^h=&kz=k%vrk+_@x@fa9nd-pef_sx32@8sws6)c#6h%j*-71(i'
...
WSGI_APPLICATION = 'AuthCrud.wsgi.application'
