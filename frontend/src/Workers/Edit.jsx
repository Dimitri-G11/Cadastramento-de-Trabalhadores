...
function Edit() {
    ...
    const submission =(data)=>{
        ...
        AxiosInstance.put(`/RegisterdWorkers/Workers/${myid}/`,{
        ...
        <div>
            <form onSubmit={handleSubmit(submission)}>
                ...
                <Box sx={{display:'felx',width:'100%',boxShadow:3,padding:4,flexDirection:'column'}}>
                        ...
                        <Box sx={{textAlign:'center',alignItems:"center",marginTop:'10px'}}><SubmitB type="submit" label="Update"></SubmitB></Box>
